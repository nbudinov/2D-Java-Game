...
public class Game extends Canvas implements Runnable {
	...
	private void endOfMapPlayerPos() {
		...
		// " iy " + player.y);
		// System.out.println("game " + this.getWindowWidth() + " screen " +
		// screen.getWidth() + "game " + this.getWindowHeight() + " screen " +
		// screen.getHeight());
		...
		else if (player.y > 128 * 16 - screen.getHeight() / 2 && player.walking) iy = -(screen.getHeight() / 2 - (level.getMapHeight() - player.y));
	}
